...
export const analyticsApi = {
  ...
  getWorkOrdersTrend: (params) => api.get('/analytics/work-orders-trend', { params }),
  getWorkOrdersBySite: (params) => api.get('/analytics/work-orders-by-site', { params }),
  getTopAssets: (params) => api.get('/analytics/top-assets', { params }),
  getTechnicianPerformance: (params) => api.get('/analytics/technician-performance', { params }),
  getSiteComparison: (params) => api.get('/analytics/site-comparison', { params }),
  getOverdueTrend: (params) => api.get('/analytics/overdue-trend', { params }),
  getWorkloadByDay: (params) => api.get('/analytics/workload-by-day', { params }),
  getEstimatedVsActual: (params) => api.get('/analytics/estimated-vs-actual', { params }),
  getWorkOrdersByCategory: (params) => api.get('/analytics/work-orders-by-category', { params }),
  getInventoryTopParts: (params) => api.get('/analytics/inventory-top-parts', { params }),
  getInventoryByCategory: (params) => api.get('/analytics/inventory-by-category', { params }),
  getInventoryCostTrend: (params) => api.get('/analytics/inventory-cost-trend', { params }),
  getPMCompliance: (params) => api.get('/analytics/pm-compliance', { params }),
  getPMScheduleStatus: (params) => api.get('/analytics/pm-status', { params }),
  getAssetStats: (params) => api.get('/analytics/asset-stats', { params }),
  getUsersByRole: (params) => api.get('/analytics/users-by-role', { params }),
  getUserGrowth: (params) => api.get('/analytics/user-growth', { params }),
  getTopRequesters: (params) => api.get('/analytics/top-requesters', { params }),
  getAuditActivity: (params) => api.get('/analytics/audit-activity', { params }),
  getMyRequests: (params) => api.get('/analytics/my-requests', { params }),
  getPreventiveVsReactive: (params) => api.get('/analytics/preventive-vs-reactive', { params }),
  getAvgResolutionTime: (params) => api.get('/analytics/avg-resolution-time', { params }),
  getInventoryStats: (params) => api.get('/analytics/inventory-stats', { params }),
  getSiteTechnicianCounts: (params) => api.get('/analytics/site-technician-counts', { params }),
};
...
export const sitesApi = {
  ...
  delete: (id: string, force = false) => api.delete(`/sites/${id}`, { params: { force } }),
  restore: (id: string) => api.post(`/sites/${id}/restore`),
